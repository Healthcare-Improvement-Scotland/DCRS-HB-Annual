...
#setwd("N:/Evidence/DMBI/Death Cert/Report - Healthboards Quarterly/his-dcrs-hb-annual")
```
...
```{r load source data and analysis}
...
```{r, fig.width=6,fig.height=3.2, message=FALSE, warning=FALSE} 
#If small board with little data then run chart analysis is not possible. THis will skip these boards
